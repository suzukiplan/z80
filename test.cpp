...
int main()
{
    ...
    mmu.RAM[0x001E] = 0x34;
    mmu.RAM[0x001F] = 0x12;
    mmu.RAM[0x0020] = 0b00000010; // LD (BC), A
    mmu.RAM[0x0021] = 0b00010010; // LD (DE), A
    mmu.RAM[0x0022] = 0b00110010; // LD ($5678), A
    mmu.RAM[0x0023] = 0x78;
    mmu.RAM[0x0024] = 0x56;
    mmu.RAM[0x0025] = 0b11101101; // LD A, I
    mmu.RAM[0x0026] = 0b01010111;
    mmu.RAM[0x0027] = 0b11101101; // LD I, A
    mmu.RAM[0x0028] = 0b01000111;
    mmu.RAM[0x0029] = 0b11101101; // LD A, R
    ...
    mmu.RAM[0x002E] = 0xCD;
    mmu.RAM[0x002F] = 0xAB;
    mmu.RAM[0x0030] = 0b11011101; // LD IX, $1234
    mmu.RAM[0x0031] = 0b00100001;
    mmu.RAM[0x0032] = 0x34;
    mmu.RAM[0x0033] = 0x12;
    mmu.RAM[0x0034] = 0b11111101; // LD IY, $5678
    mmu.RAM[0x0035] = 0b00100001;
    mmu.RAM[0x0036] = 0x78;
    mmu.RAM[0x0037] = 0x56;
